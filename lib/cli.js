import { a as historyStartDate, c as syncBars, d as barsToSeries, f as fromBarTuple, h as fetchJson, i as filterByCodes, l as createFilterRegistry, m as RateLimiter, n as StrategyRegistry, o as prepareUniverse, p as ymd, r as acquireBarsFile, t as registerAll, u as createDataSource } from "./strategies-DH191N87.js";
...
function gateLine(entry) {
	...
	const pct = (v) => v === null || v === void 0 ? "-" : `${(Number(v) * 100).toFixed(1)}%`;
	const drawdown = (v) => v === null || v === void 0 ? "-" : `-${(Number(v) * 100).toFixed(1)}%`;
	const parts = [];
	...
	push("放量涨停", m.limitUpDate === null || m.limitUpDate === void 0 ? "-" : `${m.limitUpDate}(${fmt(m.limitUpVolumeSurge, 1)}x)`, gates.volume_limit_up);
	const coolRef = m.cooldownRefDate === null || m.cooldownRefDate === void 0 ? null : String(m.cooldownRefDate);
